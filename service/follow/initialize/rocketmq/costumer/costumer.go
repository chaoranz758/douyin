...
func InitCustomer1() error {
	...
	err = c.Subscribe("followTopic1", consumer.MessageSelector{}, rocketmq1.FollowCustomer1CallBack)
	if err != nil {
		return err
	}
	err = c.Start()
...
func InitCustomer2() error {
	...
	err = c.Subscribe("followTopic2", consumer.MessageSelector{}, rocketmq1.FollowCustomer2CallBack)
	if err != nil {
		return err
	}
	err = c.Start()
...
func InitCustomer3() error {
	...
	err = c.Subscribe("followTopic3", consumer.MessageSelector{}, rocketmq1.FollowCustomer3CallBack)
	if err != nil {
		return err
	}
	err = c.Start()
