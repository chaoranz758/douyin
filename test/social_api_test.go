...
func TestRelation(t *testing.T) {
	...
	userIdA, tokenA := getTestUserToken(testUserA+"10211", e)
	userIdB, tokenB := getTestUserToken(testUserB+"10311", e)
...
func TestChat(t *testing.T) {
	...
	userIdA, tokenA := getTestUserToken(testUserA+"xx", e)
	userIdB, tokenB := getTestUserToken(testUserB+"yy", e)
